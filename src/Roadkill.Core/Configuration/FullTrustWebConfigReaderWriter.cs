...
namespace Roadkill.Core.Configuration
{
	...
	/// </summary>
	public class FullTrustWebConfigReaderWriter : IWebConfigReaderWriter
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FullTrustWebConfigReaderWriter"/> class.
		/// The class will attempt to load the Roadkill section from the web.config when the class 
		/// is instantiated, and cache it for the lifetime of the <see cref="FullTrustWebConfigReaderWriter"/> instance.
		/// </summary>
		public FullTrustWebConfigReaderWriter()
			: this("")
		{
		}

		public FullTrustWebConfigReaderWriter(string configFilePath)
		{
			if (!_isConfigLoaded)
			{
