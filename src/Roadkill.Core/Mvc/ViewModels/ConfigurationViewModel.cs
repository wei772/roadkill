...
namespace Roadkill.Core.Mvc.ViewModels
{
	...
	public class ConfigurationViewModel
	{
		...
		/// <summary>
		/// Gets an IEnumerable{SelectListItem} from a the ConfigurationViewModel.DatabaseTypesAvailable, as a default
		...
		/// <summary>
		/// Fills this instance of ConfigurationViewModel using the properties from the Settings 
		/// and the SiteSettings.
		/// </summary>
		public ConfigurationViewModel(IConfigurationStore configurationStore) : this()
		{
